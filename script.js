...
// ===== PRODUCT DATA =====
// Source: Order PDF "maple baby 2" — only items with qty ≥ 2
// Exchange rate used: R$ 3,65 / CAD (27/Mai/2026)
const PRODUCTS = [
  {
    id: 1,
  ...
  },
  {
    ...
    status: "disponivel",
    emoji: "💙",
    gradient: "linear-gradient(135deg, #EFF6FF 0%, #DBEAFE 40%, #FDF2F8 100%)",
    description: "Kit 4 bodies manga longa em azul e rosa com estampas delicadas: nuvens, bolinhas, flores e animais. Algodão 100% macio. Perfeito para os primeiros meses do bebê.",
  ...
  },
  {
    ...
    status: "disponivel",
    emoji: "🦁",
    gradient: "linear-gradient(135deg, #FEF9EE 0%, #FEF3C7 40%, #F0FDF4 100%)",
    description: "Kit 4 bodies manga longa com estampas de safari: leão, elefante, girafa e zebra. Algodão 100% macio. Cada corpinho é uma aventura diferente!",
  ...
  },
  {
    ...
    description: "Conjunto 3 peças delicado com tema de coelhinho. Cardigan de tricô rosa com aplique de coelho, body de bolinhas e calça rosa. Presentão para bebê menina!",
...
// ===================================================
const STOCK_KEY = 'maplebaby_stock_v2';
